    ...
    <>
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 md:px-8">
          {/* left cluster: menu + (back, to the right of menu) */}
          ...
          {/* account — solid brand-red button */}
          <TransitionLink
            href="/account"
            aria-label="My account"
            className="group inline-flex items-center gap-2 rounded-full bg-primary px-4 py-2 text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-cream shadow-lg shadow-primary/25 ring-1 ring-inset ring-cream/20 transition-all duration-300 hover:bg-cream hover:text-primary hover:ring-primary/40 active:scale-95"
          >
